      ...
      <div class="row-4">
        ...
        <form action="<c:url value='/usuario/actualizar' />"
          ...
          <a href="<c:url value='/usuario/listar' />"
            ...
            <img src = "C:\Users\NI5A20\Downloads\TALENTO DIGITAL\SEMANA 3\jfs_ejemplos-master-respuestas\jfs_ejemplos-master\pruebamod4\WebContent\usuario\dragon-head.svg" height = 100 width =100>
        </form>
