...
<body>
	<div class="container">
		<div class="row">
			<div class="col-sm-5 col-md-9 col-lg-2 mx-auto">
				<div class="card card-signin my-6">
					<img src="C:\Users\NI5A20\Downloads\TALENTO DIGITAL\SEMANA 3\jfs_ejemplos-master-respuestas\jfs_ejemplos-master\pruebamod4\WebContent\usuario\dragon-head.svg" height = 500 width = 500 id="icon" alt="User Icon" />
					<div class="card-body">
						<div class="container">
							<div class="row my-5">
								<div class="col-4"></div>
								<div class="row-4">
									...
									<form action="<c:url value='/usuario/ingresar' />"
										method="post">
										...
										<div class="form-group">
											<label for="anio_nac">Año de nacimiento</label> <input
												...
												id="anio_nac" placeholder="ingrese su año de nacimiento..."
												required="required" />
										</div>
