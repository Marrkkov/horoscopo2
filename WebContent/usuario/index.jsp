...
<body>
	<div class="container">
		<div class="row">
			<div class="col-sm-9 col-md-12 col-lg-2 mx-auto">
								...
								<div class="row-8">
									...
									<p>
										<a href="<c:url value='/usuario/ingresar' />"
											...
											aria-pressed="true">Ingresar nuevo </a> | <a
											href="<c:url value='/' />"
											class="btn btn-danger btn-sm active" role="button"
											...
											<c:forEach var="usuario" items="${usuarios}">
												<tr>
													...
													<td><a
														...
														data-toggle="modal" data-target="#modal${usuario.getId()}">Eliminar</a>
												</tr>
												...
												<div class="modal fade" id="modal${usuario.getId()}"
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">Está a punto de eliminar al
																usuario: ${usuario.getUsername()}.</div>
